...
let pessoa1 = new Pessoa("Ricardo", 29, "123.456.789-00");
let pessoa2 = new Pessoa("Marta", 35, "987.654.321-00");
pessoa1.exibirInfo();
pessoa2.exibirInfo();
...
class Funcionario extends Pessoa{
    ...
    constructor(nome, idade, cpf, cargo, salario){
        super(nome, idade, cpf); //super classe
        this.#cargo = cargo;
        this.#salario = salario;
    }
    //metodos publicos (get and set)
    //métodos públicos
    //getters and setters
    get getCargo(){
        return this.#cargo;
...
let funcionario1 = new Funcionario("Marcia", 51, "321.654.987-00", "Cozinheira", 2000);
