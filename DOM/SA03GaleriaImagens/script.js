...
function atualizarGaleria(){
    ...
    imagensUrl.forEach((imagem,index)=>{
        ...
        btnRemove.addEventListener("click", ()=>{ //remover a img da galeria
            imagensUrl.splice(index, 1); //remove a img pelo index do vetor
...
function atualizarCarrossel(){
    ...
    imagensUrl.forEach(imagem => {
        ...
        img.style.width = "100%";//garante o ajuste de 100% da img
        divCarrossel.appendChild(img);//add a img dentro da div 
    });
